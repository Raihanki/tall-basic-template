...
<x-dialog-modal wire:model.live="modalUpdateProduct" submit="edit">
    <x-slot name="title">
        <span class="text-2xl font-medium">Update Product</span>
    </x-slot>
    ...
    <x-slot name="footer">
        <x-secondary-button x-on:click="$wire.set('modalUpdateProduct', false)" wire:loading.attr="disabled">
            {{ __('Cancel') }}
        </x-secondary-button>
